...
alias ani=''
alias ani2=''
alias jelly="mov-cli -s ms {query} -- --url "https://127.0.0.1:8096/" --username "st4rk" --password ".""
alias prd="paru -R"
alias killdwmblock="/usr/bin/pkill -RTMIN+8 dwmblocks && dwmblocks &&"
alias smke="sudo make"
alias chmd="chmod +x "
