...
ResourcePref resources[] = {
  ...
  { "nmaster",                INTEGER,   &nmaster },
  { "mfact",                  FLOAT,     &mfact },
  /* { "color0",                 STRING,    &termcolor0 }, */
  /* { "color1",                 STRING,    &termcolor1 }, */
  /* { "color2",                 STRING,    &termcolor2 }, */
  /* { "color3",                 STRING,    &termcolor3 }, */
  /* { "color4",                 STRING,    &termcolor4 }, */
  /* { "color5",                 STRING,    &termcolor5 }, */
  /* { "color6",                 STRING,    &termcolor6 }, */
  /* { "color7",                 STRING,    &termcolor7 }, */
  /* { "color8",                 STRING,    &termcolor8 }, */
  /* { "color9",                 STRING,    &termcolor9 }, */
  /* { "color10",                STRING,    &termcolor10 }, */
  /* { "color11",                STRING,    &termcolor11 }, */
  /* { "color12",                STRING,    &termcolor12 }, */
  /* { "color13",                STRING,    &termcolor13 }, */
  /* { "color14",                STRING,    &termcolor14 }, */
  /* { "color15",                STRING,    &termcolor15 }, */
...
static const Key keys[] = {
  ...
  { MODKEY,             XK_c,                     spawn,                {.v = (const char*[]){ "dmenuhandler" , NULL} } },
  { MODKEY|ShiftMask,   XK_c,                     spawn,                {.v = (const char*[]){"dictionary", NULL } } },
